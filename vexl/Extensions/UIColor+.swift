...
private extension String {
    ...
    func argb2rgba() -> String? {
        ...
        switch (hexString.count) {
        case 4:
            let alpha = hexString[..<self.index(self.startIndex, offsetBy: 1)]
            let colors = hexString[self.index(self.startIndex, offsetBy: 1)...]
            return "#\(colors)\(alpha)"
        case 8:
            let alpha = hexString[..<self.index(self.startIndex, offsetBy: 2)]
            let colors = hexString[self.index(self.startIndex, offsetBy: 2)...]
            return "#\(colors)\(alpha)"
        default:
            return nil
        }
