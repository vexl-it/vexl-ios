...
final class ImportFacebookContactsProfileViewModel: ImportContactsViewModel {
...
final class ImportFacebookProfileViewModel: ViewModelType, ObservableObject {
    ...
    var importContactViewModel = ImportFacebookContactsProfileViewModel()
